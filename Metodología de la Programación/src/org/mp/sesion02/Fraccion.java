...
public class Fraccion extends Number implements Comparable<Fraccion> {
	 ...
	 * @return retorna el número mas grande por el que se pueden dividir dichos numeros.
	 */
	...
	public int compareTo(Fraccion otra) {
		...
		double f2 = (double)(otra.numerador)/otra.denominador;
		return Double.compare(f1, f2);
	}
	/**
	 * Metodo que nos permite dividor dos valores tipo int
	 * @return division entre el numerado y el denominador de un objeto tipo fraccion
	 */
	public int intValue() {
		return this.numerador /this.denominador;
	}
	/**
	 * Metodo que nos permite dividor dos valores tipo long
	 * @return division entre el numerado y el denominador de un obejto tipo fraccion
	 */
	public long longValue() {
		return this.numerador /this.denominador;
	}
	/**
	 * Metodo que nos permite dividor dos valores tipo float
	 * @return division entre el numerado y el denominador de un obejto tipo fraccion
	 */
	...
	/**
	 * Metodo que nos permite dividor dos valores tipo double
	 * @return division entre el numerado y el denominador de un obejto tipo fraccion
	 */
