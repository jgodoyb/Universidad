...
namespace PSS.jgb347.Practica_05
{
    ...
    public class TestBD
    {
        ...
        {
            string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Antonio.J\source\repos\2022-pss-aci117\Practica_05\Libreria\AutentificacionDB.mdf;Integrated Security=True";
            try
            {
